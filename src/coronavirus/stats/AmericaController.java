 ...
 */
public class AmericaController implements Initializable {
    ...
    @FXML
    private Button united_states;
    @FXML
    private Button mexico;
    @FXML
    private Button brazil;
    @FXML
    private Button argentina;
    @FXML
    private Button colombia;
